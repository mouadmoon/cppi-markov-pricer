...
class Grid:
    ...
    def compute_grid(self):
        ...
        # Supprime les points trop proches (doublons numériques)
        grid_values = np.unique(grid_values)  # supprime les doublons exacts
    
        # Supprime les points quasi-identiques
        mask = np.ones(len(grid_values), dtype=bool)
